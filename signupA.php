...
$errors['username'] = "<p style='color:red'>username already exist!</p>";
    ...
    $query = mysqli_query($conn, "SELECT * FROM adminis WHERE username = '".$username. "'");
  if(mysqli_num_rows(  $query) > 0){
$errors['username'] = "<p style='color:red'>username already exist!</p>";
}else{
    $sql = "INSERT INTO admins (email, username, password,first_name,second_name) VALUES ('$email', '$username', '$password','$name1','$name2')";
...
<div class="signup-form">
	...
	<div class="hint-text">Already have an account? <a href="loginA.php">Login here</a></div>
</div>
</body>
</html>