...
if(count($_POST)>0) {
    ...
    $result = mysqli_query($conn,"SELECT * FROM admins WHERE username='" . $_POST["username"] . "' and password = '". sha1($_POST["password"])."'");
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="loginA.php" method="post">
                            ...
                            <div id="register-link" class="text-right">
                                <a href="signupA.php" class="text-info">Register Here</a>
                            </div>
                        </form>
                    </div>
                </div>
