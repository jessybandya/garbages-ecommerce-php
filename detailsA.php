 ...
 -->
        ...
        <div class='card border-0'>
            ...
            <div class='card  text-xs-center border-light'>
                ...
                <div class="bd-format" >
                    <a href="profileview1A.php?id=<?php echo $a1['client_id']?>">
                        <button type="button" class="btn btn-secondary" style="background-color: green;border-radius: 20px">Owner Profile View</button>
                    </a>
