    ...
    <div class="container" style="background-image: url('images/garbage.jpg');" >
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="dbox dbox--color-1">
                    <div class="dbox__body" style="background-color: green">
                        <span class="dbox__count">Clients</span>
                        <span class="dbox__title">Summury</span>
                    </div>
                    <a href="summury.php">
                        <div class="dbox__action">
                            <button class="dbox__action__btn">Click</button>
            ...
            <div class="col-md-4">
                <div class="dbox dbox--color-2">
                    ...
                    <div class="dbox__body" style="background-color: green">
                        <span class="dbox__count">Sent</span>
                        <span class="dbox__title">Reports</span>
                    </div>
